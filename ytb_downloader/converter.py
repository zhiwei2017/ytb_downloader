...
def convert_to(downloaded_file: str, conversion_format: str = 'mp3',
    ...
    Args:
        ...
        t_end (int|None): ending point for cutting the video, if not provided, the
          whole video will be converted.
        bitrate (str): Audio bitrate, given as a string like '50k', '500k',
          '3000k'. Will determine the size and quality of the output file.
          Note that it mainly an indicative goal, the bitrate won't
          necessarily be the this in the output file.

    Returns:
        str|None: the converted file path, if conversion succeed, otherwise None.
    """
