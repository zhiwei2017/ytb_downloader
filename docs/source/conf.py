...
htmlhelp_basename = 'ytb_downloader_docs'
...
man_pages = [
    (master_doc, 'ytb_downloader', project + ' Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, project, project + ' Documentation',
     author, project, 'Download youtube videos and convert them to mp3',
     'Miscellaneous'),
]
